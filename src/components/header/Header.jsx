      ...
      <div className={navbar ? "beny_tm_topbar animate" : "beny_tm_topbar"}>
        <div className="in">
          <div className="topbar_inner">
            <div className="logo">
              <Link to="/">
                <img src="img/logo/dark.jpg" alt="brand" />
              </Link>
            </div>
            <div className="menu">
              <Scrollspy
              ...
              >
                <li className="current">
                  <a href="#home">
                    <span className="first">Acceuil</span>
                    <span className="second">Acceuil</span>
                  </a>
                </li>
                <li>
                  <a href="#about">
                ...
                <li>
                  <a href="#news">
                    <span className="first">Blog</span>
                    <span className="second">Blog</span>
                  </a>
                </li>
                <li>
                  <a href="#contact">
